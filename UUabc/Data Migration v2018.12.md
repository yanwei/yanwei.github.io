...
<p align='right'>v1.0, Last Update: 2018.11.7</p>
...
* 学生数据
  * 帐号数据 / 学生资料
  * 课时数据：1.5系统学员迁移到2.0系统，如果除去四季切齐课程包后，还有多余课时，多余的课时转换成学员账户上的U币，未来允许用U币兑换课时，或购课抵扣。
* 老师数据
  * 帐号数据 / 老师资料
  * 签约时间 / 车位信息
...
<!-- ![Data-Migration-排课进度](Data-Migration-排课进度.png) -->
...
* 随着1.5系统中的学员不断减少，班主任应尽量合并1.5系统中的车次，最终合并成每个等级一列车，以最大化车位利用率，并降低运营难度。
...
【待确定】如果学生选择转到2.0系统，学生帐号、课时等数据如何迁移？

* Case 1: 学生课时不足，补足后迁移到2.0系统，迁移后1.5系统没有剩余课时。
* Case 2: 学生课时足够，迁移到2.0系统后，课时依然有剩余，怎么处理？
...
|---|---|---|---|---|---|---|---|
|1|合并整理1.5系统学员数据|Elva|待完成|||||
|2|确定需要迁移到2.0系统的学员名单|Elva|待完成|待完成|待完成|||
|2.1|确定补足课时销售政策和价格|Eason|待完成|
|3|收集外教资料并整理翻译|Hayley|完成现有老师资料|持续性工作|持续性工作|持续性工作|持续性工作|
|4|确定需要迁移到2.0系统的老师数量|Victor|待完成|||||
|5|确定需要迁移到2.0系统的老师名单|Hayley|待完成|||||
|6|同步老师资料到2.0系统|Beauli|待完成|持续性工作|持续性工作|持续性工作|持续性工作|
|7|迁移学员资料到2.0系统+学员补课时、新系统培训等|Elva|||待完成|||
|8|2.0系统相关功能内部培训|Victor|待完成|待完成||||
|9|2.0系统外教培训|Will|待完成|待完成|持续性工作|持续性工作|持续性工作|
|10|外教薪资数据整合和BI报表|Beauli||待完成||||
|11|2.0系统老师实际转移上课平台，关闭1.5系统入口|Victor|||待完成|||
|12|1.0/1.5/2.0系统老师完全合并共用|Beauli|||||待完成|
