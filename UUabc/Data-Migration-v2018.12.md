...
<p align='right'>v1.0, Last Update: 2018.11.29</p>
...
|资产类型|处理/迁移方式|
|---|---|
|四季切齐课程包|直接迁移到2.0系统的缴费单。包场情况下，先转成标准四季切齐课时包+2.0系统中的U币，再在选课时用U币抵扣|
|1v1课时|原则上不直接迁移到2.0系统。用户可以在1.0平台消耗掉课时，或转换成一定1v4课时或U币|
|1v4课时|1.5系统学员迁移到2.0系统，如果除去四季切齐课程包后，还有多余课时，多余的课时转到2.0系统|
|直播课时|直接迁移到2.0系统|
|U币|按1:1比例，直接转移到2.0系统。未来允许用U币兑换课程、商城礼品，或购课抵扣|
|积分/等级|不迁移|
|钻石|不迁移|
|课时明细|不迁移|
|上课记录、作业和评语|不迁移|
...
* Case 4: 学生课时足够，迁移到2.0系统后，课时依然有剩余（用户屯课太多），剩余课时转到新系统。
...
* 12.1之前，老师招聘和管理相关工作仍需在1.0/1.5系统中进行，12.1～1.21期间完全合并到2.0系统（届时，除1v1学员服务外，1v4可完全放弃旧系统）。
...
|---|---|---|---|---|---|---|---|
|10|合并整理1.5系统学员数据|Elva|已完成|
|20|确定需要迁移到2.0系统的学员名单|Elva|已完成|待完成|待完成|
|21|确定补足课时销售政策和价格|Eason|已完成|
|22|清理僵尸账号，清理过期的赠送课时|Victor||待完成|
|30|收集外教资料并整理翻译|Hayley|已完成|持续性工作|持续性工作|持续性工作|持续性工作|
|40|确定需要迁移到2.0系统的老师数量|Victor|已完成|
|50|确定需要迁移到2.0系统的老师名单|Hayley|进行中|
|60|同步老系统老师资料到2.0系统|Victor|进行中|持续性工作|持续性工作|持续性工作|持续性工作|
...
|110|2.0系统老师账号迁移，并允许登录1.5系统|Hayley|||待完成|
