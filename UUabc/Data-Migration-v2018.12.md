...
<p align='right'>v1.0, Last Update: 2018.11.19</p>
...
* 学生数据
  ...
  * 账号资产
    ...
    * 直播课时：直接迁移到2.0系统。
    * 1v1课时：原则上不可以迁移到2.0系统。用户可以在1.0平台消耗掉课时。
...
* 12.1～1.21期间，通过运营手段，解决用户既要在老系统上课，又要到新系统选老师的问题
  * 临时提供两个账号，分别进入新老系统，全部迁移后再IT人工后台修改手机号码
* 1v1课时不可直接迁移到2.0系统（看数据再做决定）
